...
def get_story(story, username, protagonist, secondary, noun1, noun2, adjective1, adjective2, adjective3, adjective4, adjective5, place, emotion1, emotion2, emotion3, body_part1, body_part2, adverb1, adverb2, verb1, verb2, verb_past, objects):
  ...
  if story == "Spooky": #When user selects 'A Spooky Story'
    ...
    g_story = f'It was a {adjective1} night. {protagonist} was walking down the street heading torwards {secondary}’s place. {protagonist} and {secondary} ware going on a date that night. {protagonist} knocked, the door opened, {secondary} looked like a {adjective2} {noun1}. {protagonist} grabbed {secondary} by the {body_part1} as they headed to the {place}. They were feeling {emotion1} when they reached the {place}, they were going to {verb1}. They were having a {adjective3} time. {protagonist} stared into {secondary}’s eyes and started to caress {secondary} {adverb1} in the {body_part2}. “Every time I’m with you I feel {emotion2}, you are so {adjective4}” said {protagonist}. “I feel {emotion2} as well” {secondary} responded. {protagonist} took a {adjective5} {noun2} “Here, I got this for you”. {secondary} started to {verb2} {adverb2}, secondary was {emotion3}. They {verb_past} and kissed.'
